...
var DEFAULT_SEMANTIC = UNIFIED_PLAN;

// If browser version and name is not specified here, it should pick up DEFAULT_SEMANTIC (unified-plan)
var BROWSER_SUPPORT = {
    'chrome': {
    ...
    'ios': {
        '12.1.1.0': [UNIFIED_PLAN, PLAN_B], // 12.1.1 problem 12.3 iphone
        '12.0.0.0': [PLAN_B, UNIFIED_PLAN], // 12.xxx
        '11.0': [PLAN_B]
    },
    'safari': {
